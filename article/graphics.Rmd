...
# ------------------------------------------
# data frame with coefficients, HR and confidence intervals
# SE of all coefficients 
se <- c(0.0476, 0.0904, 0.0784, 0.0830, 0.0697, 0.0555, 0.0597, 0.0815, 0.0695, 0.0364, 0.0340, 0.0422, 0.0332, 0.0499, 0.0645, 0.0857, 0.0362, 0.0331, 0.7196, 0.0309, 0.2661, 0.7231, 0.1856, 0.8452, 4.1706, 6.8975, 0.0714, 0.9724, 2.3149, 2.3255, 0.4776, 0.7265)  

coefficientsdf <- data.frame(coefficients = names(model$coefficients), 
                             beta = as.numeric(unname(model$coefficients)),
                             SE = se,
                             HR = exp(coefficientsdf$beta),
                             upper = exp(coefficientsdf$beta + (1.96*coefficientsdf$SE)),
                             lower = exp(coefficientsdf$beta - (1.96*coefficientsdf$SE))
                             )
