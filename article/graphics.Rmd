...
vars <- "new_category + new_user + contain_unanswered + contain_answered + title_questionmark + text_contain_punct + text_all_lower + update + prior_effort + weekday + sqrt(avg_tag_score) + rcs(log10(text_length), 5) + rcs(log10(avg_tag_length + 1), 4) + rcs(log10(device_length + 1), 5) + rcs(sqrt(newline_ratio), 3)"
