...
\author{
\name{L.K.Oshita\textsuperscript{a}\thanks{CONTACT L.K.Oshita. Email: l.oshita@yahoo.com}, A.Pileggi\textsuperscript{b}}
\affil{\textsuperscript{a}iFixit; )
}
