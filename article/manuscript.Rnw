...
The final model trained on the full data set was significant with a partial likelihood ratio of \Sexpr{LR} (p-value \textless0.0001). Its $R^2$ statistic was \Sexpr{r2}, and Somers' \textit{Dxy} was \Sexpr{dxy}. 
