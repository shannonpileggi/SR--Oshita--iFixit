...
% --> apostrophy in title looks a little weird to me, but I don't mind either way
...
% Heyyy this is a dynamic document, why not make these images in-line? :-()
  ...
  Of 8,025 questions in the full data, 7,760 were in English (97\% of the full data). Of those questions, \Sexpr{scales::comma(answered)} (\Sexpr{percentans}\%) received an answer by the download date. The shortest response time was \Sexpr{shortest} hours. The longest was \Sexpr{format(longest, big.mark = ",")} hours (\Sexpr{longest_d} days). Figure \ref{fig:answertimes} shows the distribution of response times for all questions analyzed. 
...
% --> e.g., $\log\left({\textnormal{average tag length} + 1}\right)$
...
\begin{tabular}{|l L{5.5cm}|c|c|}
 ...
 \textbf{Variable} & & \textbf{Coefficient (SE)} & \textbf{p-value} \\ \hline
  ...
  \multicolumn{2}{|l|}{Weekend} & -0.1334 (0.0331)  & \textless0.0001 \\ \hline
  \multicolumn{2}{|l|}{Text contains end punctuation} & 0.0247 (0.0499) & 0.6127 \\ \hline
  \multicolumn{2}{|l|}{Text is in all lower case} & -0.1770 (0.0645) &  0.0060 \\ \hline
  \multicolumn{2}{|L{9cm}|}{Title contains terms considered frequently-used among answered questions} & 0.0475 (0.0422) &  0.2596 \\ \hline
  \multicolumn{2}{|L{9cm}|}{Title contains terms considered frequently-used among unanswered questions} & -0.2808 (0.0340)  & \textless0.0001 \\ \hline
  \multicolumn{2}{|L{9cm}|}{Title ends in a question mark} & 0.2571 (0.0332) &  \textless0.0001 \\ \hline
  \multicolumn{2}{|L{9cm}|}{User edited or added to the question's text after posting it} & 0.2983 (0.0857)  & 0.0005 \\ \hline
  \multicolumn{2}{|L{9cm}|}{User was a member for less than one day before posting} & -0.1069 (0.0364)  & 0.0031 \\ \hline
  \multicolumn{2}{|L{9cm}|}{User made an effort to solve the problem prior to asking the question} & -0.0724 (0.0362)  & 0.0448 \\ \hline
  \multicolumn{2}{|L{9cm}|}{Square root of the average tag frequency} & 2.2609 (0.7196)  & 0.0020 \\ \hline
\end{tabular} 
...
The final model, as a whole, was significant with a partial likelihood ratio of 1265.29 (p-value \textless0.0001). Its $R^2$ statistic was 0.15, and Somers' \textit{Dxy} was 0.267. 
...
\begin{itemize}
  \item The estimated hazard of receiving an answer is 154.1\% higher (95\% CI (131.5\%, 180.0\%)) for questions pertaining to Apple products than the hazard for questions about Android and Other phones, controlling for all other predictors.
  \item The estimated hazard of receiving an answer for questions posted on a weekend is 12.5\% lower (95\% CI (6.7\%, 18.0\%)) than the hazard for questions posted on a weekday, controlling for all other predictors.
  \item The estimated hazard of receiving an answer is 24.5\% lower (95\% CI (19.3\%, 29.4\%)) for questions with titles that contain at least one word considered to be frequently-used among unanswered questions, than the hazard for questions with titles that do not, controlling for all other predictors. 
\end{itemize}
