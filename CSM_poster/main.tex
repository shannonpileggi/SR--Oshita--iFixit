...
Predicted hazard ratios were entered into separate Cox models as the single predictor. Resulting $R^2$, concordance, Somers' \textit{Dxy}, partial likelihood ratio (PLR) and p-value, were averaged over each iteration and assessed.  
...
Table \ref{table:1} displays average performance metrics achieved in cross-validation, as well as for the model fit to the full data. 
