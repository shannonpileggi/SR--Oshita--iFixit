...
\end{figure}
  ...
  Of 8,025 questions in the full data set, \Sexpr{nrow(x)} were in English (97\% of the full data). Of those questions, \Sexpr{answered} (\Sexpr{percentans}}\%) received an answer by the download date. The shortest answer time was \Sexpr{shortest} hours. The longest was \Sexpr{longest} hours (\Sexpr{longest_d} days). Figure ~\ref{fig:answertimes} shows that the distribution of answer times for all questions is extremely right-skewed. 
