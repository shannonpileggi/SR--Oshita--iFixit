...
```{r, echo = FALSE}
x$text_length2 <- x$text_length**2 # for future use
x$sqrt_tag_score <- sqrt(x$avg_tag_score)
...
rms::survplot(final, new_category, time.inc = 100, col = 1:length(levels(x$new_category)), xlab = "hour")
