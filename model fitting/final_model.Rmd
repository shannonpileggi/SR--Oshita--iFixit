...
```{r, echo = FALSE}
# build model on train1 (df set to 5 for all splines at first, but setting tag and newline to 4 minimized AIC and performed best)
